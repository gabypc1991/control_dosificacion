...
void intro_0(){ 
 ...
 lcd.setCursor(0, 0); lcd.print("--------------v1.X--");
...
void menu_1(){ 
   ...
   lcd.setCursor(0,1); lcd.print("FORMULAS          >2");
...
/////////////////////////Accion_4_1 //////////////////////////////
    void accion_4_1(){         
        if(pulsacion == '*') {contador = 6;edit = false;lcd.clear();}          
    }
/////////////////////////Menu_4_2  //////////////////////////////////
    void menu_4_2(){ 
      pos_col = 11;
...
/////////////////////////Accion_4_2 //////////////////////////////
    void accion_4_2(){ 
        if(pulsacion == '*') {contador = 7;edit = false;lcd.clear();}
    }
/////////////////////////Menu_4_3  //////////////////////////////////
    void menu_4_3(){ 
      pos_col = 11;
...
/////////////////////////Accion_4_3 //////////////////////////////
    void accion_4_3(){ 
        if(pulsacion == '*') {contador = 8;edit = false;lcd.clear();}
    }
/////////////////////////Menu_4_4  //////////////////////////////////
    void menu_4_4(){ 
      pos_col = 11;
