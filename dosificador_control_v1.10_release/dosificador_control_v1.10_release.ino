...
//byte colPins[COLS] = {44,42,40,38}; //Puntos de conexion del teclado??
//byte rowPins[ROWS] = {46,48,50,52};

byte rowPins[COLS] = {38,40,42,44}; //Puntos de conexion del teclado panel version v1.10 v1.1xPr
byte colPins[ROWS] = {46,48,50,52};

//byte rowPins[ROWS] = {38,40,42,44}; //Puntos de conexion del teclado de prueba
...
void loop() {
 ...
 if(act_in3 != true && contador != 3){contador = 16;}
...
// if(contador == 21){ menu_3_1();accion_3_1();}
 ...
 if(contador == 11){ menu_formPag4();accion_formPag4();}
 if(contador == 10){ menu_formPag3();accion_formPag3();}
 if(contador == 9){ menu_formPag2();accion_formPag2();}
 if(contador == 8){ menu_edicionTEstabiliz();accion_edicionTEstabiliz();}
 if(contador == 7){ menu_parametros();accion_parametros();}
 if(contador == 6){ menu_editDosis2();accion_editDosis2();}
 if(contador == 5){ menu_editDosis1();accion_editDosis1();}
 if(contador == 4){ menu_editFormula();accion_editFormula();}
